...
`decoder_modules/radio/src/demodulators/radio_module.h` 中找到 `nb.init(NULL, 500.0 / 24000.0, 10.0);` 将 24000 提升到 **48000**. `decoder_modules/radio/src/demodulators/dsb.h`, `decoder_modules/radio/src/demodulators/lsb.h`, `decoder_modules/radio/src/demodulators/usb.h` 中找到 `getIFSampleRate()` 处, 将返回值 24000 提升到 **48000**. 修改完毕. 按照文档直接编译即可.
